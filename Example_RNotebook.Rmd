...
###this is a test to show committing and different versions
...
When you save the notebook, an HTML  containing the code and output will be saved alongside it (click the *Preview* button or press *Ctrl+Shift+K* to preview the HTML file).
