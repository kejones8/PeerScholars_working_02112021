...
\usepackage{biblatex}
\addbibresource{Data-driven.bib}
...
% Abstract
\begin{abstract}
    Add your abstract here. asdfkljasdlfjsdf \cite{kim_data-driven_2020}
\end{abstract}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/midwest-2.jpeg}
